...
**Generated:** 2026-07-24T14:16:32.006139
...
|------|-----------------|------------|---------------|---------------|
| distributed_gpu | 1,133 samples/sec | 4.48 | 10 | 0 |

## Per-Model Processing (samples)

| Model | Single GPU | Hybrid | Distributed |
|-------|-----------|--------|-------------|
| anomaly_detector | - | - | 1000 |
| efficientnet_b0 | - | - | 20 |
| ew_classifier | - | - | 1000 |
| mobilenetv3 | - | - | 20 |
| resnet18 | - | - | 20 |
| rf_fingerprinter | - | - | 1000 |
| signal_denoiser | - | - | 1000 |
| threat_prioritizer | - | - | 1000 |
| yolov8_nano | - | - | 5 |
| yolov8_small | - | - | 5 |
